...
import ProgresiveSVGImage from "../progresive-svg-image/progresive-svg-image";
...
function SVGPanel(props) {
  useEffect(() => {}, [props.bounds, props.path]);
    ...
    >
      <defs>
        ...
        <pattern
          ...
          height="100%"
        >
          <ProgresiveSVGImage url={props.url} urlHD={props.urlHD} />
        </pattern>
      </defs>
      <g
        id="Page-1"
